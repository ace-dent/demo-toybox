...
-- I dont think this will save anything, as we'd need to issue `⁶.`
-- before any one-off chrs. It's better to store a run of tiles.
...
--110 'n' tile_n
poke(0x5600+(8* 110), -- Single use x
 128, -- ▒▒▒▒▒▒▒█
 192, -- ▒▒▒▒▒▒██
 224, -- ▒▒▒▒▒███
 224, -- ▒▒▒▒▒███
...
--111 'o' tile_o
poke(0x5600+(8* 111), -- Single use x
   3, -- ██▒▒▒▒▒▒
   3, -- ██▒▒▒▒▒▒
   7, -- ███▒▒▒▒▒
   7, -- ███▒▒▒▒▒
